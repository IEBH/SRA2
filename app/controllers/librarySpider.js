app.controller('librarySpiderController', function($scope, $location, $rootScope, Libraries, Tasks) {
	...
	$scope.$watch('library', function() {
		...
		$rootScope.$broadcast('setTitle', 'Spider');
	});
	// }}}

	$scope.submit = function() {
		Tasks.fromLibrary({id: $scope.library._id, worker: 'library-spider'}, {settings: {
